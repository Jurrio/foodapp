...
public class EmailValidator {
	...
	public static boolean validate(String email) throws EmailFormatException {
		if (!checkEmail(email)) {
	 ...
	 * 
	 * System.out.println(
	 * " ≥льк≥сть символ≥в (example@com.ua), €к≥ сто€ть перед знаком С@Т маЇ бути не менше 4-ох ≥ не б≥льше 31-го"
	 * ); System.out.println(checkWithRegExp("test@yandex.ua"));
	 * System.out.println(checkWithRegExp(
	 * "1234567890123456789012345678901@yandex.ua"));
	 * System.out.println(checkWithRegExp("tes@yandex.ua"));
	 * System.out.println(checkWithRegExp(
	 * "12345678901234567890123456789012@yandex.ua"));
	 * 
	 * System.out.println(
	 * "“акож в ц≥й частин≥ допускаютьс€ т≥льки л≥тери, цифри та знаки крапки ≥ нижнього п≥дкресленн€. ¬с≥ решта символ≥в, так≥ €к С%Т, С*Т, С(Т, С)Т, С=Т, С+Т ≥ т.д., не допускаютьс€."
	 * ); System.out.println(checkWithRegExp(
	 * "abcdefghijklmnopqrstuvwxyz0.98_@yandex.ua"));
	 ...
	 * 
	 * System.out.println(
	 * "¬ частин≥, €ка стоњть п≥сл€ знаку С@Т (example@com.ua), маЇ бути принаймн≥ 1 буквенний символ, €кий розм≥щений до крапки."
	 ...
	 * 
	 * System.out.println(
	 * "ќстанн€ частина емейлу, €ка розташована п≥сл€ крапки повинна м≥стити або 2 або 3 буквенний символа."
